...
mixin _$RoundModel {
 ...
 String get id; int get roundNumber; String get neighborhoodId; NeighborhoodModel? get neighborhood; int get status; DateTime get startDate; DateTime get endDate; double get totalTransportCost; List<RoundProductModel> get roundProducts;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RoundModel&&(identical(other.id, id) || other.id == id)&&(identical(other.roundNumber, roundNumber) || other.roundNumber == roundNumber)&&(identical(other.neighborhoodId, neighborhoodId) || other.neighborhoodId == neighborhoodId)&&(identical(other.neighborhood, neighborhood) || other.neighborhood == neighborhood)&&(identical(other.status, status) || other.status == status)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.totalTransportCost, totalTransportCost) || other.totalTransportCost == totalTransportCost)&&const DeepCollectionEquality().equals(other.roundProducts, roundProducts));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,roundNumber,neighborhoodId,neighborhood,status,startDate,endDate,totalTransportCost,const DeepCollectionEquality().hash(roundProducts));

@override
String toString() {
  return 'RoundModel(id: $id, roundNumber: $roundNumber, neighborhoodId: $neighborhoodId, neighborhood: $neighborhood, status: $status, startDate: $startDate, endDate: $endDate, totalTransportCost: $totalTransportCost, roundProducts: $roundProducts)';
}
...
@useResult
$Res call({
 String id, int roundNumber, String neighborhoodId, NeighborhoodModel? neighborhood, int status, DateTime startDate, DateTime endDate, double totalTransportCost, List<RoundProductModel> roundProducts
});
...
/// Create a copy of RoundModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? roundNumber = null,Object? neighborhoodId = null,Object? neighborhood = freezed,Object? status = null,Object? startDate = null,Object? endDate = null,Object? totalTransportCost = null,Object? roundProducts = null,}) {
...
as double,roundProducts: null == roundProducts ? _self.roundProducts : roundProducts // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  int roundNumber,  String neighborhoodId,  NeighborhoodModel? neighborhood,  int status,  DateTime startDate,  DateTime endDate,  double totalTransportCost,  List<RoundProductModel> roundProducts)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RoundModel() when $default != null:
return $default(_that.id,_that.roundNumber,_that.neighborhoodId,_that.neighborhood,_that.status,_that.startDate,_that.endDate,_that.totalTransportCost,_that.roundProducts);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  int roundNumber,  String neighborhoodId,  NeighborhoodModel? neighborhood,  int status,  DateTime startDate,  DateTime endDate,  double totalTransportCost,  List<RoundProductModel> roundProducts)  $default,) {final _that = this;
switch (_that) {
case _RoundModel():
return $default(_that.id,_that.roundNumber,_that.neighborhoodId,_that.neighborhood,_that.status,_that.startDate,_that.endDate,_that.totalTransportCost,_that.roundProducts);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  int roundNumber,  String neighborhoodId,  NeighborhoodModel? neighborhood,  int status,  DateTime startDate,  DateTime endDate,  double totalTransportCost,  List<RoundProductModel> roundProducts)?  $default,) {final _that = this;
switch (_that) {
case _RoundModel() when $default != null:
return $default(_that.id,_that.roundNumber,_that.neighborhoodId,_that.neighborhood,_that.status,_that.startDate,_that.endDate,_that.totalTransportCost,_that.roundProducts);case _:
  return null;
...
class _RoundModel implements RoundModel {
  const _RoundModel({required this.id, this.roundNumber = 0, required this.neighborhoodId, this.neighborhood, required this.status, required this.startDate, required this.endDate, required this.totalTransportCost, final  List<RoundProductModel> roundProducts = const []}): _roundProducts = roundProducts;
...
@override final  double totalTransportCost;
 final  List<RoundProductModel> _roundProducts;
@override@JsonKey() List<RoundProductModel> get roundProducts {
  if (_roundProducts is EqualUnmodifiableListView) return _roundProducts;
  // ignore: implicit_dynamic_type
  return EqualUnmodifiableListView(_roundProducts);
}
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _RoundModel&&(identical(other.id, id) || other.id == id)&&(identical(other.roundNumber, roundNumber) || other.roundNumber == roundNumber)&&(identical(other.neighborhoodId, neighborhoodId) || other.neighborhoodId == neighborhoodId)&&(identical(other.neighborhood, neighborhood) || other.neighborhood == neighborhood)&&(identical(other.status, status) || other.status == status)&&(identical(other.startDate, startDate) || other.startDate == startDate)&&(identical(other.endDate, endDate) || other.endDate == endDate)&&(identical(other.totalTransportCost, totalTransportCost) || other.totalTransportCost == totalTransportCost)&&const DeepCollectionEquality().equals(other._roundProducts, _roundProducts));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,roundNumber,neighborhoodId,neighborhood,status,startDate,endDate,totalTransportCost,const DeepCollectionEquality().hash(_roundProducts));
...
/// Create a copy of RoundModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? roundNumber = null,Object? neighborhoodId = null,Object? neighborhood = freezed,Object? status = null,Object? startDate = null,Object? endDate = null,Object? totalTransportCost = null,Object? roundProducts = null,}) {
...
as DateTime,endDate: null == endDate ? _self.endDate : endDate // ignore: cast_nullable_to_non_nullable
as DateTime,totalTransportCost: null == totalTransportCost ? _self.totalTransportCost : totalTransportCost // ignore: cast_nullable_to_non_nullable
as double,roundProducts: null == roundProducts ? _self._roundProducts : roundProducts // ignore: cast_nullable_to_non_nullable
as List<RoundProductModel>,
  ));
}
...
mixin _$RoundProductModel {
 ...
 String get id; String get productId; ProductModel? get product; double get targetQuantityKg; double get accumulatedQuantityKg; double get estimatedWholesalePrice; double? get actualWholesalePrice; double get marginPerKg; double get operationalSharePerKg;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,productId,product,targetQuantityKg,accumulatedQuantityKg,estimatedWholesalePrice,actualWholesalePrice,marginPerKg,operationalSharePerKg);

@override
String toString() {
  return 'RoundProductModel(id: $id, productId: $productId, product: $product, targetQuantityKg: $targetQuantityKg, accumulatedQuantityKg: $accumulatedQuantityKg, estimatedWholesalePrice: $estimatedWholesalePrice, actualWholesalePrice: $actualWholesalePrice, marginPerKg: $marginPerKg, operationalSharePerKg: $operationalSharePerKg)';
}
...
@useResult
$Res call({
 String id, String productId, ProductModel? product, double targetQuantityKg, double accumulatedQuantityKg, double estimatedWholesalePrice, double? actualWholesalePrice, double marginPerKg, double operationalSharePerKg
});
...
/// Create a copy of RoundProductModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? productId = null,Object? product = freezed,Object? targetQuantityKg = null,Object? accumulatedQuantityKg = null,Object? estimatedWholesalePrice = null,Object? actualWholesalePrice = freezed,Object? marginPerKg = null,Object? operationalSharePerKg = null,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String productId,  ProductModel? product,  double targetQuantityKg,  double accumulatedQuantityKg,  double estimatedWholesalePrice,  double? actualWholesalePrice,  double marginPerKg,  double operationalSharePerKg)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RoundProductModel() when $default != null:
return $default(_that.id,_that.productId,_that.product,_that.targetQuantityKg,_that.accumulatedQuantityKg,_that.estimatedWholesalePrice,_that.actualWholesalePrice,_that.marginPerKg,_that.operationalSharePerKg);case _:
  return orElse();
...
class _RoundProductModel implements RoundProductModel {
  const _RoundProductModel({this.id = '', required this.productId, this.product, required this.targetQuantityKg, this.accumulatedQuantityKg = 0.0, required this.estimatedWholesalePrice, this.actualWholesalePrice, required this.marginPerKg, required this.operationalSharePerKg});
...
@override@JsonKey() final  double accumulatedQuantityKg;
...
/// Create a copy of RoundProductModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? productId = null,Object? product = freezed,Object? targetQuantityKg = null,Object? accumulatedQuantityKg = null,Object? estimatedWholesalePrice = null,Object? actualWholesalePrice = freezed,Object? marginPerKg = null,Object? operationalSharePerKg = null,}) {
